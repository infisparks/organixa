  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="grid grid-cols-1 lg:grid-cols-3 gap-8">
      ...
      <div className="lg:col-span-2 space-y-8">
        ...
        {/* Basic Information */}
        <Card className="rounded-3xl shadow-sm border bg-white border-slate-100">
          <CardHeader>
          ...
          <CardContent className="space-y-8">
            ...
            <div className="space-y-4">
              ...
              <div className="flex flex-col gap-3">
                ...
                <Button type="button" onClick={handleAddCategory} className="w-full sm:w-auto h-11 bg-slate-900 hover:bg-black text-white font-bold rounded-xl h-11 transition-all">
                  <Plus className="h-4 w-4 mr-2" />
                  Add
                </Button>
              </div>
        ...
        {/* Images */}
        <Card className="rounded-3xl shadow-sm border bg-gradient-to-br from-pink-100 via-yellow-50 to-green-100">
          <CardHeader>
            ...
            >
              <div className="flex flex-col items-center">
                ...
                <Button
                  ...
                  className="h-11 bg-slate-900 hover:bg-black text-white font-bold rounded-xl h-11 transition-all"
        ...
        <Card className="rounded-3xl shadow-sm border bg-gradient-to-br from-blue-100 via-purple-50 to-pink-100">
          <CardHeader>
