...
export default function RegistrationForm() {
  ...
  return (
    <div className="min-h-screen bg-gradi12345
    azt-to-br from-blue-50 to-indigo-50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-3xl w-full mx-auto">
        <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
          ...
          <div className="bg-gradient-to-r from-blue-600 to-indigo-700 p-8">
            ...
            <div className="flex justify-center mt-6 space-x-4 px-2">
              <button
                type="button"
